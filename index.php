...
<!-- 					<div class="col-4 navigation">
		...
		<div class="container">
			...
			<div class="row no-gutters">
					...
					<div class="col-sm-6 col-md-3">
						...
						<ul>
							<li><a href="demos/customizer/opacity_transition.html">Opacity transition</a></li>
							<li><a href="demos/customizer/3d_cube_rotate.html">CSS cube rorate</a></li>
							<li><a href="demos/customizer/spatial_images.html">Spatial images</a></li>
						</ul>
					</div>
					<div class="col-sm-6 col-md-3">
						<!-- <header class="friendly"> <h6>Title</h6> </header> -->
						<ul>
							<li><a href="demos/customizer/opacity_elements.html">Opacity elements</a></li>
							<li><a href="demos/customizer/showing_text.html">Showing a text</a></li>
							<li><a href="demos/customizer/progressbar.html">Progress bar</a></li>
						</ul>
					</div>
					<div class="col-sm-6 col-md-3">
						<!-- <header class="friendly"> <h6>Title</h6> </header> -->
						<ul>
							<li><a href="demos/customizer/sliding_images.html">Sliding images</a></li>
							<li><a href="demos/customizer/change_text_color.html">Change text color</a></li>
							<li><a href="demos/customizer/class_manipulation.html">Class manipulation</a></li>
						</ul>
					</div>
					<div class="col-sm-6 col-md-3">
						<!-- <header class="friendly"> <h6>Title</h6> </header> -->
						<ul>
							<li><a href="demos/customizer/repeat_actions.html">Repeat actions</a></li>
							<li><a href="demos/customizer/fullscreen_gallery.html">Fullscreen gallery</a></li>
							<li><a href="demos/customizer/scene_information.html">Scene information</a></li>
						</ul>
					</div>
	...
	<section class="normal-screen screen-fullpage-example">
		...
		<div class="row no-gutters">
			...
			<div class="col-sm-12 text-center">
				<a href="example.html" style="display: block;border:none;">
	...
	<section class="normal-screen screen-buy">
		...
		<script type="text/javascript" src="js/enedScroll.min.js?ver=1.5.0"></script>
